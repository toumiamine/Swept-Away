...
class StreamBuildTrack extends StatefulWidget {
  @override
  _StreamBuildTrackState createState() => _StreamBuildTrackState();
}

class _StreamBuildTrackState extends State<StreamBuildTrack> {
  int num_orders;
